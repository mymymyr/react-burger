...
export type TWsReduser = {
  wsStartConnecting: boolean
  wsWithTokenStartConnecting: boolean
  wsConnected: boolean
  wsConnectedWithToken: boolean
  orders: TOrder[]
  profileOrders: TOrder[]
  total: number | null
  totalToday: number | null
  startHeartbeat: boolean
  startHeartbeatWithToken: boolean
}

const initialState: TWsReduser = {
...
export const wsReducer = (state = initialState, action: TWsActions): TWsReduser => {
  switch (action.type) {
