...
function HomePage () {
  ...
  const handleOpenOrderModal = (item: string[]) => {
    ...
    openOrderModalAsync(item).catch((err: Error) => { console.error(err.message); });
  };
